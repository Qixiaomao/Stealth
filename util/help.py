...
class Help:
      ...
      @classmethod
      def  parse_args(cls):
          # description 参数可以用于插入描述脚本用途的信息，可以为空
         parser = argparse.ArgumentParser(formatter_class=RawTextHelpFormatter, prog='python Stealth.py<OPTIONS>''domain',description="Collect message")
